                    ...
                    @foreach($risottomeats  as $risottomeat)
                        <a class="text-decoration-none"
                           ...
                           href="{{ route('risotto',['id'=>$risottomeat->id])}}">
                            <div class="card">
                            <img src="{{ asset($risottomeat->risottos_image) }}"
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text cuprum text-dark h6 ">
                                        ...
                                        {{ $risottomeat->risottos_description_5}}
                                    </p>
                                </div>
                            </div>
                        </a>
                    ...
                    @foreach($risottochikens  as $risottochiken)
                        <a class="text-decoration-none"
                           ...
                           href="{{ route('risotto',['id'=>$risottochiken->id])}}">
                            <div class="card">
                            <img src="{{ asset($risottochiken->risottos_image) }}"
                                 class="img-fluid card-img">
                                <div class="card-body">
                                    <h5 class="card-title cuprum text-dark">
                                        <b>
                                    ...
                                    <p class="card-text cuprum text-dark h6 ">
                                        ...
                                        {{ $risottochiken->risottos_description_5}}
                                    </p>
                                </div>
                            </div>
                        </a>
                    ...
                    @foreach($risottosseafoods  as $risottosseafood)
                        <a class="text-decoration-none"
                           ...
                           href="{{ route('risotto',['id'=>$risottosseafood->id])}}">
                            <div class="card">
                            <img src="{{ asset($risottosseafood->risottos_image) }}"
                                 class="img-fluid card-img">
                                <div class="card-body">
                                    <h5 class="card-title cuprum text-dark">
                                        <b>
                                    ...
                                    <p class="card-text cuprum text-dark h6 ">
                                        ...
                                        {{ $risottosseafood->risottos_description_5}}
                                    </p>
                                </div>
                            </div>
                        </a>
                    ...
                    @foreach($risottovegetables  as $risottovegetable)
                        <a class="text-decoration-none"
                           ...
                           href="{{ route('risotto',['id'=>$risottovegetable->id])}}">
                            <div class="card">
                            <img src="{{ asset($risottovegetable->risottos_image) }}"
                                 class="img-fluid card-img">
                                <div class="card-body">
                                    <h5 class="card-title cuprum text-dark">
                                        <b>
                                    ...
                                    <p class="card-text cuprum text-dark h6 ">
                                        ...
                                        {{ $risottovegetable->risottos_description_5}}
                                    </p>
                                </div>
                            </div>
                        </a>
